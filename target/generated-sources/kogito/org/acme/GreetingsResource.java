...
public class GreetingsResource {
    ...
    @Operation(summary = "greetings", description = "")
    public GreetingsModelOutput updateModel_greetings(@PathVariable("id") String id, @RequestBody(required = false) GreetingsModel resource) {
    ...
    @Operation(summary = "greetings", description = "")
    public GreetingsModelOutput updateModelPartial_greetings(@PathVariable("id") String id, @RequestBody(required = false) GreetingsModel resource) {
    ...
    public List<TaskModel> getTasks_greetings(@PathVariable("id") String id, @RequestParam(value = "user", required = false) final String user, @RequestParam(value = "group", required = false) final List<String> groups) {
        return processService.getTasks(process, id, SecurityPolicy.of(IdentityProviders.of(user, groups))).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND)).stream().map(org.acme.Greetings_TaskModelFactory::from).collect(Collectors.toList());
    }
}
