...
public class GreetingsProcess extends org.kie.kogito.process.impl.AbstractProcess<org.acme.GreetingsModel> {
    ...
    public org.acme.GreetingsProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.correlation.CompositeCorrelation correlation, org.acme.GreetingsModel value) {
        return new org.acme.GreetingsProcessInstance(this, value, businessKey, this.createProcessRuntime(), correlation);
    }
